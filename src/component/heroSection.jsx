...
function Body(){
    return(
       <>
        <div className="bg-[#151218] py-20 h-[680px] bg-[url('../../repo/lower image.svg')] #new ">
...
<div className=" mb-8 py-6">
    ...
    <div className="text-white mt-10  ">
     ...
     <h1 className="text-7xl font-san font-semibold leading-[90px] ">
         Every order<br/>
         fulfilled <span className="font-serif">, </span> <span className="text-emerald-300">on time.</span>
         </h1>
